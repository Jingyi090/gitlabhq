...
gem 'rails', '~> 7.0.8', '>= 7.0.8.1' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'sprockets', '~> 3.7.3' # rubocop:todo Gemfile/MissingFeatureCategory
...
# Files attachments
gem 'carrierwave', '~> 2.2', '>= 2.2.6' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'gitlab-fog-azure-rm', '~> 1.9.0', require: 'fog/azurerm' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'nokogiri', '~> 1.15', '>= 1.15.6' # rubocop:todo Gemfile/MissingFeatureCategory
