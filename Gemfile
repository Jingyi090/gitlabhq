...
gem 'sprockets', '~> 4.2.0' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'omniauth', '~> 2.1.1' # rubocop:todo Gemfile/MissingFeatureCategory
gem 'omniauth-auth0', '~> 3.1', '>= 3.1.1' # rubocop:todo Gemfile/MissingFeatureCategory
gem 'omniauth-azure-activedirectory-v2', '~> 2.0', '>= 2.0.1' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'omniauth-facebook', '~> 5.0.0' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'omniauth-saml', '~> 2.1.1' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'rack-oauth2', '~> 2.0.0' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'google-apis-core', '~> 0.11.0' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'html-pipeline', '~> 3.0.0' # rubocop:todo Gemfile/MissingFeatureCategory
gem 'deckar01-task_list', '2.3.4' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'truncato', '~> 0.7.13' # rubocop:todo Gemfile/MissingFeatureCategory
...
# Background jobs
gem 'sidekiq', '~> 7.0.0' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'licensee', '~> 9.16', '>= 9.16.1' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'request_store', '~> 1.6.0' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'sentry-sidekiq', '~> 5.9.0' # rubocop:todo Gemfile/MissingFeatureCategory

# PostgreSQL query parsing
#
gem 'pg_query', '~> 5.0.0' # rubocop:todo Gemfile/MissingFeatureCategory
...
# I18n
gem 'rails-i18n', '~> 7.0', '>= 7.0.5', feature_category: :internationalization
...
# Metrics
gem 'webrick', '~> 1.8.2', require: false # rubocop:todo Gemfile/MissingFeatureCategory
...
group :development, :test do
  ...
  gem 'rspec-rails', '~> 6.0.4' # rubocop:todo Gemfile/MissingFeatureCategory
...
group :development, :test, :omnibus do
  gem 'license_finder', '~> 7.1', '>= 7.1.0', require: false # rubocop:todo Gemfile/MissingFeatureCategory
end
...
group :test do
  ...
  gem 'capybara', '~> 3.40', '>= 3.40.0' # rubocop:todo Gemfile/MissingFeatureCategory
  gem 'capybara-screenshot', '~> 1.0.26' # rubocop:todo Gemfile/MissingFeatureCategory
  gem 'selenium-webdriver', '~> 4.16', '>= 4.16.0' # rubocop:todo Gemfile/MissingFeatureCategory
  ...
  gem 'email_spec', '~> 2.2.1' # rubocop:todo Gemfile/MissingFeatureCategory
  ...
  gem 'derailed_benchmarks', '>= 2.2.0', require: false # rubocop:todo Gemfile/MissingFeatureCategory
...
# OAuth
gem 'oauth2', '~> 2.0', '>= 2.0.10' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'gitaly', '~> 16.5.0.0.0' # rubocop:todo Gemfile/MissingFeatureCategory

# KAS GRPC protocol definitions
gem 'kas-grpc', '~> 0.4.0', feature_category: :deployment_management

gem 'grpc', '~> 1.58.3' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'gitlab-experiment', '~> 0.9.1' # rubocop:todo Gemfile/MissingFeatureCategory
...
# Email validation
gem 'valid_email', '~> 0.1', '>= 0.1.4' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'webauthn', '~> 3.1', '>= 3.1.0' # rubocop:todo Gemfile/MissingFeatureCategory
...
# Apple plist parsing
gem 'CFPropertyList', '~> 3.0.6' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'net-http', '= 0.2.0' # rubocop:todo Gemfile/MissingFeatureCategory
