...
gem 'rexml', '~> 3.3.6' # rubocop:todo Gemfile/MissingFeatureCategory
...
gem 'kramdown', '~> 2.4.0' # rubocop:todo Gemfile/MissingFeatureCategory
...
group :development do
  ...
  gem 'rubocop', '>= 1.58.0', feature_category: :tooling
